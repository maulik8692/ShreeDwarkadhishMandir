...
function SaveForm() {
    showProgress();
    var ComplementaryRequest = {};
    ComplementaryRequest.Description = $("#Description").val();
    ComplementaryRequest.ItemDetails = transactionDetails;
    $.ajax({
        url: "/SamagriTransaction/Complementary",
        data: JSON.stringify(ComplementaryRequest),
        dataType: "json",
        type: "POST",
        contentType: "application/json; charset=utf-8",
        success: function (jsondata) {
            alert("Bhandar has been Complementary successfully.");
            hideProgress();
