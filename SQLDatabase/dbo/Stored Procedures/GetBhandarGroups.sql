...
BEGIN     
 ...
 (    
  select    
  Count(BG.Id)over() AS total,@PageNumber as page,@PageSize as records,BG.Id,BG.MandirId,BG.Name,BG.GroupCode,BG.Description,BG.IsJewellery,BG.IsSamagri,BG.IsBhandar,BG.IsActive    
  from    
 ...
 SP.Id,SP.MandirId,SP.Name,SP.GroupCode,SP.Description,SP.IsJewellery,SP.IsSamagri,SP.IsBhandar,SP.IsActive    
 FROM SP    
